<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <a href="index.html" class="app-brand-link">
      ...
      <span class="app-brand-text demo menu-text fw-bold">QUIZ</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item {{ request()->is('admin/jenis-soal*') ? 'active open' : '' }}">
      <a href="{{ route('admin.jenis-soal.index') }}" class="menu-link">
