...
@section('content')
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <a href="/admin/soal-awalan" class="btn btn-outline-primary mb-3">
    ...
    <div class="card">
      <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <a href="/admin/soal-awalan/{{ $id_instansi }}/tambah-soal/create" class="btn btn-primary">
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        table = $('#{{ $table_id }}').DataTable({
          ...
          serverSide: true,
          ajax: {
            url: '{{ url('admin/getSoalAwal') }}/' + {{ $id_instansi }},
            type: "POST",
      ...
      function deleteData(id) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: "{{ url('/admin/soal-awalan/' . $id_instansi . '/tambah-soal') }}/" + id,
              data: {
                _method: "DELETE",
                _token: "{{ csrf_token() }}"
              },
