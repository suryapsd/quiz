...
@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    <a href="/admin/soal-awalan/{{ $id_instansi }}/tambah-soal" class="btn btn-outline-primary mb-3">
    ...
    <div class="card mb-4">
      ...
      <form class="card-body" action="/admin/soal-awalan/{{ $id_instansi }}/tambah-soal" method="post"
