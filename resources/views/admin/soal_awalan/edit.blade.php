...
@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
      <h5 class="card-header">Edit Soal Awalan Instansi {{ $instansi->nama_instansi }} </h5>
      <form class="card-body" action="/admin/soal-awalan/{{ $id_instansi }}/tambah-soal/{{ $soal->id }}" method="post"
